  ...
  return (
    <div className="bg-[#0D1824] border border-white/[0.06] rounded-[16px] p-6">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <h3 className="text-sm font-semibold text-[#F4F6F9]">Dados da loja</h3>
          <p className="text-xs text-[#5C6E84]">Informações gerais do estabelecimento</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs text-[#5C6E84] mb-1.5">Nome da loja</label>
            <input value={form.nome} onChange={e => set('nome', e.target.value)}
              placeholder="JM Store Importados"
              className="w-full bg-[#0A111E] border border-white/[0.08] rounded-[9px] px-3 py-2.5 text-sm text-[#D4DEEA] placeholder:text-[#3F516A] outline-none focus:border-white/20" />
          </div>
          <div>
            <label className="block text-xs text-[#5C6E84] mb-1.5">CNPJ</label>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs text-[#5C6E84] mb-1.5">Telefone</label>
            <input value={form.telefone} onChange={e => set('telefone', e.target.value)}
              placeholder="(19) 99999-9999"
              className="w-full bg-[#0A111E] border border-white/[0.08] rounded-[9px] px-3 py-2.5 text-sm text-[#D4DEEA] placeholder:text-[#3F516A] outline-none focus:border-white/20" />
          </div>
          <div>
            <label className="block text-xs text-[#5C6E84] mb-1.5">E-mail</label>
        ...
        <div>
          <label className="block text-xs text-[#5C6E84] mb-1.5">Endereço</label>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs text-[#5C6E84] mb-1.5">Cidade</label>
            <input value={form.cidade} onChange={e => set('cidade', e.target.value)}
              placeholder="Mogi Guaçu"
              className="w-full bg-[#0A111E] border border-white/[0.08] rounded-[9px] px-3 py-2.5 text-sm text-[#D4DEEA] placeholder:text-[#3F516A] outline-none focus:border-white/20" />
          </div>
          <div>
            <label className="block text-xs text-[#5C6E84] mb-1.5">Estado</label>
        ...
        <div>
          <label className="block text-xs text-[#5C6E84] mb-1.5">Site</label>
