            ...
            <table className="w-full">
              ...
              <tbody>
                {usuarios.length === 0 ? (
                  ...
                  return (
                    <tr key={u.id} className="border-b border-[#16212E]/[0.08] hover:bg-[#16212E]/[0.04] transition-colors last:border-0">
                      {/* Usuário */}
                      ...
                      {/* Ação */}
                      <td className="px-5 py-4">
                        <button className="px-3 py-1.5 text-xs font-semibold text-[#788698] hover:text-[#16212E] bg-[#16212E]/[0.04] hover:bg-[#16212E]/[0.04] rounded-[8px] transition-colors">
                          ✎ Editar
                        </button>
                      </td>
                    </tr>
